...
ActiveRecord::Schema[8.0].define(version: 2025_10_26_040337) do
  ...
  create_table "comercios", force: :cascade do |t|
    ...
    t.index ["pueblo_magico_id"], name: "index_comercios_on_pueblo_magico_id"
  end
  ...
  create_table "eventos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pueblo_magico_id"], name: "index_eventos_on_pueblo_magico_id"
  end
  ...
  create_table "turismos", force: :cascade do |t|
    t.string "nombre"
    t.text "descripcion"
    t.string "horario"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pueblo_magico_id"], name: "index_turismos_on_pueblo_magico_id"
  end
  ...
  add_foreign_key "comercios", "pueblo_magicos"
  add_foreign_key "eventos", "pueblo_magicos"
  ...
  add_foreign_key "turismos", "pueblo_magicos"
end
